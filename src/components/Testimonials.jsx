          ...
          <SwiperSlide>
            <div className="slide-item">
              ...
              <p>
                ...
                adores his time there, and I have peace of mind knowing he's in
                good hands. Thank you, Team Pawsitive!
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="slide-item">
              ...
              <p>
                I am incredibly impressed by the level of care, compassion, and
                companionship that Pawsitive provides! The journals and photos
                and notes are wonderful to read. I can tell that Pawsitive hires
          ...
          <SwiperSlide>
            <div className="slide-item">
              ...
              <p>
                ...
                knowledgeable, compassionate, and friendly. They provide a safe
                and nurturing environment that my cat, Luna, adores. I wouldn't
                trust anyone else with her well-being!
              </p>
            </div>
          </SwiperSlide>
        </Swiper>
